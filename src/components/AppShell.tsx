...
import { Moon, Sun, Plus, LayoutDashboard, Library, Sparkles } from "lucide-react";
      ...
      <header className="sticky top-0 z-40 border-b border-border bg-background/85 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-7xl items-center gap-6 px-4 sm:px-8">
          <Link to="/" className="flex items-center gap-2">
            <div className="grid h-8 w-8 place-items-center rounded-md bg-[var(--ember)] text-[oklch(0.2_0.02_60)] font-display text-xl leading-none">
              L
            </div>
      ...
      <footer className="mt-24 border-t border-border">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-6 text-xs text-muted-foreground sm:px-8">
          <div className="flex items-center gap-2">
            ...
            <span>Lumen — turning YouTube into deliberate study.</span>
          </div>
